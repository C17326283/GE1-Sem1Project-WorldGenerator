...
public class PlayerMovement : MonoBehaviour
{
    ...
    void Update()
    {
        /*
        RaycastHit hit;
        if (Physics.Raycast(transform.position, planet.transform.position - gameObject.transform.position, out hit, 10000))
        {
            Vector3.Lerp(transform.position, hit.transform.position, speed);
        }
        */
        void Update()
        {
